    ...
    <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-lg sm:rounded-lg">
        <div class="p-6 sm:p-8">
            <div class="flex justify-between items-center mb-8 pb-4 border-b border-gray-200 dark:border-gray-700">
                <div>
                    <h3 class="text-3xl font-bold text-gray-900 dark:text-gray-100 mb-2" style="color: #430a1e;">All
                        Categories</h3>
                ...
                @auth
                    @if(auth()->user()->name === 'admin')
                        <a href="{{ route('admin.categories.create') }}"
                            ...
                            style="background: #6c1835; color: white;" onmouseover="this.style.background='#49091f'"
                ...
                @else
                    <div class="text-sm text-gray-600 dark:text-gray-400">
                        <a href="{{ route('login') }}" class="text-blue-600 hover:text-blue-800 font-medium">Login as admin</a>
                    ...
                    <thead>
                        <tr style="background: linear-gradient(to right, #f8f9fa, #e9ecef);">
                            <th class="px-6 py-4 text-left text-xs font-bold text-gray-700 uppercase tracking-wider"
                                style="color: #430a1e;">ID</th>
                            <th class="px-6 py-4 text-left text-xs font-bold text-gray-700 uppercase tracking-wider"
                                style="color: #430a1e;">Name</th>
                            <th class="px-6 py-4 text-left text-xs font-bold text-gray-700 uppercase tracking-wider"
                                style="color: #430a1e;">Products Count</th>
                            <th class="px-6 py-4 text-center text-xs font-bold text-gray-700 uppercase tracking-wider"
                                style="color: #430a1e;">Actions</th>
                        </tr>
                    </thead>
                    <tbody class="bg-white">
                        @forelse($categories as $category)
                            <tr class="hover:bg-gray-50 transition-colors duration-150"
                                style="background: white; margin-bottom: 12px; border-bottom: 2px solid #e5e7eb;">
                                <td class="px-6 py-6 whitespace-nowrap text-sm font-semibold text-gray-700">{{ $category->id }}
                                </td>
                                ...
                                <td class="px-6 py-6 whitespace-nowrap">
                                    <div class="text-sm font-semibold text-gray-700">
                                        <span class="inline-flex items-center px-3 py-1 rounded-full text-xs font-medium"
                                            style="background: #f8d7e0; color: #430a1e;">
                                        ...
                                        @if(auth()->user()->name === 'admin')
                                            <div class="flex items-center justify-center space-x-4">
                                                <a href="{{ route('admin.categories.show', $category) }}"
                                                    ...
                                                    onmouseout="this.style.background='#6c1835'" title="View Details">
                                                ...
                                                <a href="{{ route('admin.categories.edit', $category) }}"
                                                    ...
                                                    style="background: #6c1835; color: white; min-width: 80px; height: 32px;"
                                                    onmouseover="this.style.background='#49091f'"
                                                    onmouseout="this.style.background='#6c1835'" title="Edit Category">
