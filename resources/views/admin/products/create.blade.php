...
<div class="bg-white dark:bg-gray-800 overflow-hidden shadow-lg sm:rounded-lg">
    <div class="p-6 sm:p-8">
        <div class="mb-8 pb-4 border-b border-gray-200 dark:border-gray-700">
            <h3 class="text-3xl font-bold mb-2 text-center" style="color: #430a1e;">Create New Product</h3>
        </div>
        <form action="{{ route('admin.products.store') }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="mb-6 px-4">
                ...
                <input type="text" name="image" id="image" value="{{ old('image') }}" placeholder="e.g., habo bag2.jpg"
                    class="mt-1 block w-full rounded-lg border-2 border-gray-300 shadow-sm px-4 py-2.5 transition-colors duration-200"
                    onfocus="this.style.borderColor='#6c1835'"
                    onblur="this.style.borderColor='#d1d5db'">
            ...
            <div class="mb-6 px-4">
                ...
                <div class="mt-3">
                    ...
                    <img id="image-preview" src="{{ asset('frontend/images/' . (old('image') ?: 'placeholder.jpg')) }}" alt="Preview" class="h-32 w-32 object-cover rounded border border-gray-200">
