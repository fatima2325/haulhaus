...
@section('main-container')
    ...
    <div class="container static-page-content">
        <h1 class="page-title">Return and Exchange Policy</h1>

        <h2>1. Eligibility</h2>
        <p>Items are eligible for return or exchange within 14 days of the delivery date. The item must be unused, in the same condition that you received it, and in the original packaging.</p>
